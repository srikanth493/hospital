...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { cost: @medicine.cost, expiry_date: @medicine.expiry_date, name: @medicine.name, number_of_tablets: @medicine.number_of_tablets } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { cost: @medicine.cost, expiry_date: @medicine.expiry_date, name: @medicine.name, number_of_tablets: @medicine.number_of_tablets } }
