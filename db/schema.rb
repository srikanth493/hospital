...
ActiveRecord::Schema.define(version: 2018_10_02_162416) do
  ...
  create_table "bills_medicines", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
